...
## link to our analysis View the detailed analysis in our Jupyter Notebook (http://localhost:8889/lab/tree/analysis/analysis1.ipynb
## link to our analysis View the detailed analysis in our Jupyter Notebook http://localhost:8889/lab/tree/analysis/analysis2.ipynb
...
![Plot_2](images/analysis3image2.png)

##### This box plot provides additional insights beyond just the average grade by showing the distribution of grades within each subject and campus. Comparing the box plots of different subjects or campuses suggests that online learning may have helped students to reach their highest potential grades. However, in 2021, when classes returned to normal or a hybrid online/in-person format, the lowest grades were also achieved, indicating that the effectiveness of online learning may be affected by the mode of instruction.
